            ...
            if(error) {
             ...
             if(error) {
              ...
              var pageCnt = Math.ceil(productsCnt / traPerPage);
                ...
                if(error) {
                  logError4(res,error,query,'EPC0015');
                } else {
                    res.render('partcar/index-partcar', { 
                                'user'            : req.user,
                                'langVar'         : language,
...
exports.appProductItem = function(db) {
 ...
 return function(req, res){
     var category = 'partcar';
     var productsCol = db.get('products_partcar');
     var appLanguageCol = db.get('app_text_language');
